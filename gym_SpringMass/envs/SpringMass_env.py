...
class SpringMassDiscrete(gym.Env):
    """Custom Environment that follows gym interface"""
    #metadata = {'render.modes': ['human']}
    metadata = {'render.modes': ['console']}

    def __init__(self, K=1, M=1, C=0, g = 0, MaxForce = 3, n_actions = 3):
        super(SpringMassDiscrete, self).__init__() 
        ...
        self.ForceVec = np.linspace(-MaxForce,MaxForce,n_actions)
        ...
        self.observation_space = spaces.Box(low=-self.MaxState, high=self.MaxState,dtype=np.float16)
